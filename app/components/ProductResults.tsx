          ...
          >
            ...
            <div className="flex min-w-0 flex-1 flex-col">
              ...
              <a
                ...
                className="mt-2 inline-flex w-fit items-center justify-center rounded-lg bg-[#3b9eff] px-3 py-1.5 text-xs font-medium text-white transition hover:bg-[#2d8ef0]"
              >
                구매하기
              </a>
            </div>
